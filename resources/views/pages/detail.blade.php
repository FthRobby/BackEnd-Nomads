                ...
                <div class="row">
                    <div class="col-lg-8 pl-lg-0">
                        <div class="card card-details">
                            <h1 class="font-weight-bold">Nusa Penida</h1>
                            <p>Republic of Indonesia Raya</p>
                            <div class="gallery">
                                <div class="xzoom-container">
                                    <img src="{{ url('frontend/images/details_page/details-1.jpg') }}"
                                        class="xzoom" id="xzoom-default"
                                        xoriginal="{{ url('frontend/images/details_page/details-1.jpg') }}" />
                                </div>
                                <div class="xzoom-thumbs">
                                    <a href="{{ url('frontend/images/details_page/details-1.jpg') }}">
                                        <img src="{{ url('frontend/images/details_page/details-1.jpg') }}"
                                            class="xzoom-gallery" width="128"
                                            xpreview="{{ url('frontend/images/details_page/details-1.jpg') }}" />
                                    </a>
                                    <a href="{{ url('frontend/images/details_page/details-1.jpg') }}">
                                        <img src="{{ url('frontend/images/details_page/details-1.jpg') }}"
                                            class="xzoom-gallery" width="128"
                            ...
                            <div class="features row">
                                <div class="col-md-4">
                                    <img src="{{ url('frontend//images/details_page/ic_event.pn') }}g" alt=""
                                ...
                                <div class="col-md-4 border-left">
                                    <img src="{{ url('frontend/images/details_page/ic_bahasa.png') }}" alt=""
                                        class="features-image" />
                                    <div class="description">
                                        <h3>Language</h3>
                                ...
                                <div class="col-md-4 border-left">
                                    <img src="{{ url('frontend/images/details_page/ic_foods.png') }}" alt=""
                                        class="features-image" />
                                    <div class="description">
                                        <h3>Foods</h3>
                                        <p>Local Foods</p>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="join-container">
                            <a href="{{ route('checkout') }}" class="btn btn-block btn-join-now mt-3 py2">Join Now</a>
                        </div>
                    </div>
                </div>
            </div>
